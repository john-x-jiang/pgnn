...
class HeartDataLoader(DataLoader):
    def __init__(self, batch_size, data_dir='data/', split='train', train_name='train', shuffle=True,
        ...
        self.dataset = HeartGraphDataset(data_dir, data_name, signal_type, num_mesh, seq_len, split, train_name)
